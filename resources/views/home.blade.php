      ...
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
          ...
          <div class="w-full sm:w-1/2 p-6">
            <img src="{{ url('storage/img/omnis.png') }}">
          </div>
        </div>
      ...
      <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          ...
          <div class="flex flex-wrap items-center justify-center">
              ...
              <div class="text-center text-gray-500">
                  <img class="mx-auto mb-4 h-36" src="{{ url('storage/img/entreprises/' . $sponsor->name . '.png') }}" alt="logo">
    ...
    <section class="bg-gray-100">
      <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          ...
          <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              ...
              <div class="text-center text-gray-500">
                  <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="{{ url('storage/img/membres/' . $member->fullname . '.png') }}">
                  <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                      {{ $member->fullname }}
                  </h3>
      ...
      <div class="container mx-auto px-8">
        <div class="w-full flex flex-col md:flex-row py-6">
          <div class="flex-1 mb-6 text-black">
            <div class="text-pink-600 no-underline hover:no-underline font-bold text-2xl lg:text-4xl">
